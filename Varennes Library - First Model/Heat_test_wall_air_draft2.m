...
dTdt(1,1) = (1.0/(C1*6e+6))*((T6-T1)*U61+(To-T1)*U01*100+(T7-T1)*U17+(T2-T1)*U12+0.5*Q2);
...
dTdt(6,1)=(1.0/(kef*C6*6e+6))*((To-T6)*U06*100+(T1-T6)*U61+(T7-T6)*U67+(T2-T6)*U62+0.15*S*scf2)
dTdt(7,1)=(T6*U67+T1*U17+T8*U78*10000+0.196*S*scf2)/(U67+U17+U78*10000)-T7;
dTdt(8,1)=(1/(kef*C8*1e+8))*((T7-T8)*U78*10000+(T10-T8)*U810);
dTdt(9,1)= (1/(C10*6e+6))*((T8-T10)*U810+(T5-T10)*U510+(T16-T10)*U1016+(T11-T10)*U1011+(T15-T10)*U1510+(To-T10)*U010*100+0.5*Q2);
...
dTdt(14,1)=(1/(kef*C15*1e+6))*((To-T15)*U015*10+(T16-T15)*U1516+(T10-T15)*U1510+(T11-T15)*U1511+0.15*S*scf1);
