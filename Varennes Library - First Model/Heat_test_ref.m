...
dTdt(3,1) = (1.0/(1.3*C3*1e+7))*((T4-T3)*U34*10000+(T2-T3)*U23*10000);
dTdt(4,1)=(T3*U34*10000+T5*U45*10000+Q1)/(U34*10000+U45*10000)-T4;
dTdt(5,1)=(1/(1.3*C5*1e+7))*((T4-T5)*U45*10000+(T10-T5)*U510);
...
dTdt(8,1)=(1/(1.3*C8*1e+8))*((T7-T8)*U78*10000+(T10-T8)*U810);
...
dTdt(11,1)=(1/(1.3*C12*1e+7))*((T11-T12)*U1112*10000+(T13-T12)*U1213*10000);
dTdt(12,1)=(T12*U1213*10000+T14*U1314*10000+0.67*Q2)/(U1213*10000+U1314*10000)-T13;
dTdt(13,1)=(1/(1.3*C14*1e+7))*((T13-T14)*U1314*10000+(To-T14+6)*0*U010/2);
...
dTdt(16,1)=(1/(1.3*C17*1e+8))*((T16-T17)*U1617*10000+(To-T16+6)*0*U010/2);
end
