...
function dTdt = Heat_test_original(t,var,To_inp,Q1_inp,Q2_inp,S_inp,Tg_inp)
T1=var(1);
T2=var(2);
T3=var(3);
T4=var(4);
...
dTdt(6,1)=(1.0/(1.3*C6*1e+6))*((To-T6)*U06*100+(T1-T6)*U61+(T7-T6)*U67+(T2-T6)*U62+0.15*S)
...
dTdt(14,1)=(1/(1.3*C15*1e+6))*((To-T15)*U015*10+(T16-T15)*U1516+(T10-T15)*U1510+(T11-T15)*U1511+0.15*S);
...
% dTdt(6,1)=(1.0/(1.3*C6*1e+7))*((To-T6)*U06*100+(T1-T6)*U61+(T7-T6)*U67+(T2-T6)*U62+0.15*S);
% dTdt(14,1)=(1/(1.3*C15*1e+7))*((To-T15)*U015*10+(T16-T15)*U1516+(T10-T15)*U1510+(T11-T15)*U1511+0.15*S);
...
% dTdt(1,1) = (T6*U61*10000+To*U01*100+T7*U17+T2*U12)/(U61*10000+U01*100+U12+U17)-T1;
...
% dTdt(6,1)=(1.0/(C6*1e+7))*((To-T6)*U06*100+(T1-T6)*U61*10000+(T7-T6)*U67*1000+(T2-T6)*U62*1000+0.15*S);
% dTdt(7,1)=(T6*U67*1000+T1*U17+T8*U78*10000+0.27*S)/(U67*1000+U17+U78*10000)-T7;
% dTdt(8,1)=(1/(C8*1e+8))*((T7-T8)*U78*10000+(T10-T8)*U810*1000);
% dTdt(9,1)=-T10+(T8*U810*100+T5*U510*100+T16*U1016+T11*U1011+T15*U1510*1000+To*U010*100+0.37*Q2)/(U810*100+U510*100+U1016+U1011+U1510*1000+U010*100);
...
% dTdt(14,1)=(1/(C15*1e+7))*((To-T15)*U015*10+(T16-T15)*U1516*1000+(T10-T15)*U1510*1000+(T11-T15)*U1511*1000+0.15*S);
